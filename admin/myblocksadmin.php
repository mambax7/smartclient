...
/**
* $Id: myblocksadmin.php,v 1.3 2005/04/19 18:20:55 fx2024 Exp $
* Module: SmartClient
...
function list_blocks()
{
	...
	<form action='admin.php' name='blockadmin' method='post'>
		...
		<tr valign='middle'>
			<th>"._AM_TITLE."</th>
			<th align='center' nowrap='nowrap'>"._AM_SCLIENT_POSITION."</th>
...
smartclient_adminMenu(2, _AM_SCLIENT_BLOCKSANDGROUPS);
