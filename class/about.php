...
/**
* $Id: about.php,v 1.2 2005/04/19 18:20:56 fx2024 Exp $
* Module: SmartClient
...
class SmartclientAbout
{
	...
	function SmartclientAbout($aboutTitle='About')
	{
		...
		$this->_lang_author_info = _MI_SCLIENT_AUTHOR_INFO;
		$this->_lang_developer_lead = _MI_SCLIENT_DEVELOPER_LEAD;
		$this->_lang_developer_contributor = _MI_SCLIENT_DEVELOPER_CONTRIBUTOR;
		$this->_lang_developer_website = _MI_SCLIENT_DEVELOPER_WEBSITE;
		$this->_lang_developer_email = _MI_SCLIENT_DEVELOPER_EMAIL;
		$this->_lang_developer_credits = _MI_SCLIENT_DEVELOPER_CREDITS;
		$this->_lang_module_info = _MI_SCLIENT_MODULE_INFO;
		$this->_lang_module_status = _MI_SCLIENT_MODULE_STATUS;
		$this->_lang_module_release_date =_MI_SCLIENT_MODULE_RELEASE_DATE ;
		$this->_lang_module_demo = _MI_SCLIENT_MODULE_DEMO;
		$this->_lang_module_support = _MI_SCLIENT_MODULE_SUPPORT;
		$this->_lang_module_bug = _MI_SCLIENT_MODULE_BUG;
		$this->_lang_module_submit_bug = _MI_SCLIENT_MODULE_SUBMIT_BUG;
		$this->_lang_module_feature = _MI_SCLIENT_MODULE_FEATURE;
		$this->_lang_module_submit_feature = _MI_SCLIENT_MODULE_SUBMIT_FEATURE;
		$this->_lang_module_disclaimer = _MI_SCLIENT_MODULE_DISCLAIMER;
		$this->_lang_author_word = _MI_SCLIENT_AUTHOR_WORD;
		$this->_lang_version_history = _MI_SCLIENT_VERSION_HISTORY;
		$this->_lang_by = _MI_SCLIENT_BY;
	}
